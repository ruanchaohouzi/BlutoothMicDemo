package com.shuwen.bluetoothmicdemo.restapi.asrdemo;

import android.os.Environment;

import com.shuwen.bluetoothmicdemo.restapi.common.ConnUtil;
import com.shuwen.bluetoothmicdemo.restapi.common.DemoException;
import com.shuwen.bluetoothmicdemo.restapi.common.TokenHolder;
...
//    }
    ...
    private final String appKey = "Cc9ex55LnF8DrOE89hoVUT3a";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "5009e998fccd38fc200dea47ac60ac66";

    // 需要识别的文件
    //private final String filename = Environment.getExternalStorageDirectory().getAbsolutePath() + "/16k_test.pcm";
    private final String filename = Environment.getExternalStorageDirectory().getAbsolutePath() + "/receiver.pcm";
